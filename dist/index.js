...
const testPersonalitySocial_1 = require("./simulation/testPersonalitySocial");
const testSleepCycle_1 = require("./simulation/testSleepCycle");
const testBiologicalBalance_1 = require("./simulation/testBiologicalBalance");
const runSimulation_1 = require("./simulation/runSimulation");
console.log('=================================================================');
console.log('  IVANIA — FASE: BALANCE BIOLÓGICO Y RUTINAS DIURNAS/NOCTURNAS');
console.log('=================================================================\n');
// 1. Pruebas unitarias aisladas de personalidad
(0, testPersonalitySocial_1.runIsolatedPersonalityTests)();
// 2. Pruebas unitarias aisladas de ciclo de sueño
(0, testSleepCycle_1.runIsolatedSleepTests)();
// 3. Pruebas unitarias aisladas de balance biológico
(0, testBiologicalBalance_1.runIsolatedBiologicalTests)();
...
console.log('━'.repeat(65) + '\n');
const results = (0, runSimulation_1.runDaySimulation)();
